							...
							<section className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
								<div className="sm:text-center lg:text-left">
									...
									<p className="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0">
										...
										provides some of the region{`'`}s best locally sourced meat
										and produce at a fair price.
									</p>
								</div>
							</section>
						</div>
					...
					<div className="pb-4 w-full lg:w-2/3 mx-auto md:space-x-3">
						...
						<div className="relative">
							<Image
								...
								width={1000}
							/>
							<div className="w-full md:w-3/4 lg:w-full mx-auto opacity-0 hover:opacity-100 p-8 duration-300 absolute inset-0 z-10 flex justify-center items-center text-md text-white bg-black bg-opacity-60 rounded-3xl">
								At Game{`'`}s, we pride ourself on the quality and price of our
								meat products. We take special care in ensuring a consistent
								quality control for our loyal patrons.
							</div>
						</div>
					</div>
					<div className="pb-4 w-full lg:w-2/3 mx-auto md:space-x-3">
					...
					<div className="pb-4 w-full lg:w-2/3 mx-auto md:space-x-3">
						...
						<div className="relative">
							...
							<div className="w-full md:w-3/4 lg:w-full mx-auto opacity-0 hover:opacity-100 p-8 duration-300 absolute inset-0 z-10 flex justify-center items-center text-md text-white bg-black bg-opacity-60 rounded-3xl">
								...
								bakers to provided some of the community{`'`}s richest baked
								goods.
							</div>
						</div>
					</div>
				...
				<section className="block md:flex justify-around p-4 lg:p-8">
					<div className="p-12 md:w-1/2 text-center">
						...
						<p className="leading-relaxed text-lg">
							...
							young girl and it{`'`}s still going strong. The meats are
							beautiful and fresh. You can even buy cases of meat. And the old
							fashion candy and cookies are amazing! If you haven{`'`}t been,
							you should go!
						</p>
				...
				<section className="bg-green-600">
					<div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
						...
						<p className="mb-8 lg:mb-16 font-light text-center text-neutral-900 sm:text-xl">
							Did we make your day? Do we carrying everything you shop for? Let
							us know.
						</p>
						<form action="#" className="space-y-8">
							<div>
								...
								<input
									type="email"
									id="email"
									className="shadow-sm bg-neutral-900 border text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500 shadow-sm-light"
							...
							<div>
								...
								<input
									type="text"
									id="subject"
									className="block p-3 w-full text-sm bg-neutral-900 rounded-lg bordershadow-sm focus:ring-primary-500 focus:border-primary-500 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500 shadow-sm-light"
							...
							<div className="sm:col-span-2">
								...
								<textarea
									id="message"
									rows="6"
									className="block p-2.5 w-full text-sm bg-neutral-900 rounded-lg shadow-sm border focus:ring-primary-500 focus:border-primary-500 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500"
									placeholder="Leave a comment..."
								></textarea>
							</div>
							<button
								type="submit"
								className="py-3 px-5 text-sm font-medium text-center text-neutral-900 hover:text-white rounded-lg bg-primary-700 sm:w-fit focus:ring-4 focus:outline-none bg-primary-600 hover:bg-neutral-900 focus:ring-neutral-900"
							>
								Send message
							</button>
						</form>
